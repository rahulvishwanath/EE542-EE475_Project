/**
 * @file haptic_drv.h
 * @brief Header file for DRV2605 haptic motor driver interface.
 *
 * This file contains register definitions, constants, and function
 * prototypes for interfacing with the DRV2605 haptic feedback driver
 * over I2C.
 */

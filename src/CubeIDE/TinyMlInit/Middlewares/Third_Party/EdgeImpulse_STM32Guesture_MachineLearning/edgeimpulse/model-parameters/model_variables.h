...
const char* ei_classifier_inferencing_categories[] = { "doubletap", "idle", "tap" };

EI_CLASSIFIER_DSP_AXES_INDEX_TYPE ei_dsp_config_20_axes[] = { 0, 1, 2 };
...
const uint32_t ei_learning_block_22_inputs[2] = { 20,21 };
const uint8_t ei_learning_block_22_inputs_size = 2;
...
const ei_impulse_t impulse_616883_0 = {
    .project_id = 616883,
    .project_owner = "Rahul Vishwanath",
    .project_name = "STM32Guesture",
    .impulse_id = 1,
    .impulse_name = "Impulse #1",
    .deploy_version = 2,

    .nn_input_frame_size = 60,
    .raw_sample_count = 222,
    .raw_samples_per_frame = 3,
    .dsp_input_frame_size = 222 * 3,
    .input_width = 0,
    .input_height = 0,
    .input_frames = 0,
    .interval_ms = 9.00900900900901,
    .frequency = 111,
...
ei_impulse_handle_t impulse_handle_616883_0 = ei_impulse_handle_t( &impulse_616883_0 );
ei_impulse_handle_t& ei_default_impulse = impulse_handle_616883_0;

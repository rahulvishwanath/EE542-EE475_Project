...
const char* ei_classifier_inferencing_categories[] = { "circle", "doubletap", "idle", "rightswipe" };
...
EI_CLASSIFIER_DSP_AXES_INDEX_TYPE ei_dsp_config_3_axes[] = { 0, 1, 2, 3, 4, 5 };
...
const ei_impulse_t impulse_631242_0 = {
    .project_id = 631242,
    .project_owner = "Rahul Vishwanath",
    .project_name = "STM32GuestureV2",
    .impulse_id = 1,
    .impulse_name = "Impulse #1",
    .deploy_version = 3,

    .nn_input_frame_size = 264,
    .raw_sample_count = 315,
    .raw_samples_per_frame = 6,
    .dsp_input_frame_size = 315 * 6,
    .input_width = 0,
    .input_height = 0,
    .input_frames = 0,
    .interval_ms = 9.523809523809524,
    .frequency = 105,
...
ei_impulse_handle_t impulse_handle_631242_0 = ei_impulse_handle_t( &impulse_631242_0 );
ei_impulse_handle_t& ei_default_impulse = impulse_handle_631242_0;
